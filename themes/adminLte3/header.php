...
use  config\themes,request\get,security\control;
control::loginControl();
$themePath=themes::themeBaseDirectory(). DIRECTORY_SEPARATOR.themes::themeActiveDirectory();
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Xmd Docker Admin Panel</title>
  <meta name="author" content="Harun UlUDAĞ"/>
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?=$themePath?>/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?=$themePath?>/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?=$themePath?>/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?=$themePath?>/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
...
>>>>>>> b05cee1d97e6c0896ce44ecff90ed8d49ed7fdd3
          <li class="nav-item">
            <a href="?manuelContainerSetup" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p title=" veri tabanina  her hangi bir keleme yapılmaz master kurulumu  için  gerekli  ve sunucu testi  için">
                Manule Continer Kurulum
          ...
          <li class="nav-item">
            <a href="?privateServerNodeSetup" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p title="Özel sunucu Node Kurulumu">
                Özel Node Kurulumu
                <span class="right badge badge-danger">Private</span>
          ...
          <li class="nav-item">
            <a href="?orders" class="nav-link">
              ...
              <p>
                 Siparişler
                <span class="right badge badge-danger">orders</span>
              </p>
            </a>
          </li>
